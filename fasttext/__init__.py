...
allowing imports like 'from fasttext.relevance import FastTextRelevanceChecker'
"""
...
try:
    ...
    import warnings
    warnings.warn("Could not import FastTextRelevanceChecker. Make sure relevance.py exists in the fasttext directory.") 